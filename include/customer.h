...
bool deposit(int connFD)
{
    ...
    if (get_account_details(connFD, &account))
    {
        ...
        if (account.active)
        {
            ...
            write(connFD, "\n\n\t\t Sorry!! It seems your account has been deactivated!^", strlen("\n\n\t\t Sorry!! It seems your account has been deactivated!^"));
        read(connFD, readBuffer, sizeof(readBuffer)); // Dummy read
...
bool get_balance(int connFD)
{
    ...
    if (get_account_details(connFD, &account))
    {
        ...
        if (account.active)
        {
            sprintf(buffer, "\n\n\t\t ______________BALANCE SLIP___________\n\n\t\t  You have ₹ %ld  in the world bank^", account.balance);
